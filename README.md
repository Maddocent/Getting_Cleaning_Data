...
* An R-markdown file belonging to the "run_analysis.R" file that generates an "run_analysis.html" file, explaining the different steps of the R script and shows the apporapropriate output.
